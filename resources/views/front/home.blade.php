...
<head>
    ...
    <style>
        ...
        .cat-card,.product-card{
            box-shadow: 5px 5px 40px 10px #BC846C !important;
        }
        .bg-dark, .box, .card-body{
            background-color: #3B1200 !important;
			color: white !important;
        }
		.table,.card-header, .card-footer,.wrapper, .card{
			background-color:#FFEFE8 !important;
		}
		.mainTable,.card,.box {
			box-shadow: 5px 5px 40px 10px #BC846C;
			}
	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
                <!-- <img src="{{asset('front-assets/images/beyondbuylogo.jpg')}}" alt=""> -->
				<a href="index.php" class="text-decoration-none">
					<span class="h1  text-primary bg-dark px-2">BEyOND</span>
					<span class="h1  text-dark bg-primary px-2 ml-n1">BuY</span>
				</a>
			</div>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="index.php" class="text-decoration-none mobile-logo">
				<span class="h2 text-primary bg-dark">BEyOND </span>
				<span class="h2  text-white px-2">BuY</span>
			</a>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>Copyright &copy; 2024 All rights reserved to Payel Banerjee.</p>
					</div>
				</div>
			</div>
		</div>
